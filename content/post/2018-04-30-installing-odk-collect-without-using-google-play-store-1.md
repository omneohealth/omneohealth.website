---
title: Installing ODK Collect without using Google Play Store - Approach 1
author: ~
date: '2018-04-30T11:54:00'
...
First you need to download the **Open Data Kit APK**. **APK** is short for Android application package which is the package file format used by the Android operating system for distribution and installation of mobile apps. Here are the steps to download the **Open Data Kit APK**.

### 1.1 Go to the Open Data Kit website

On your web browser, type in <a href="https://opendatakit.org.">https://opendatakit.org.</a> You will then see the following webpage on your browser.

<img src="/img/tutorials/go-to-the-open-data-kit-website.png" />

### 1.2 Go to the Download page

On top of the webpage, you will see the menu of the website one of which is named <em **'Download'**.

Click on ***'Download'***.

<img src="/img/tutorials/go-to-the-download-page.png" />
<br />
...
Once you have found the **ODK Collect APK**, click on the link.

<img src="/img/tutorials/select-the-odk-collect-apk-from-the-download-list-1.png" />
<br />

### 1.4 Click Download

<img src="/img/tutorials/click-download.png" />
<br />

### 1.5 Find the downloaded ODK Collect APK

By default, all downloads are saved in the computer's **Download** folder. Navigate to your computer's **Download** folder to see that the **ODK Collect APK** has been downloaded successfully.

<img src="/img/tutorials/find-the-downloaded-odk-collect-apk.png" />
<br />

### 1.6 Move ODK Collect APK to your Desktop
This step is not absolutely necessary but it will make things easier in terms of the next steps because it will make it easier for you to locate the **ODK Collect APK** file. Drag the ODK Collect APK file from the **Downloads** folder onto your **Desktop**.

<img src="/img/tutorials/move-odk-collect-apk-to-your-desktop.png" />
<br/>

### 1.6 Move ODK Collect APK to your Desktop
You will now see the **ODK Collect APK** on your **Desktop** making it easier to access later for the next steps.

<img src="/img/tutorials/16-move-odk-collect-apk-to-your-desktop.png" />
<br />
...
### 2.1 Connect your tablet to your computer

Using the the USB to Micro-USB cable supplied with your tablet, connect the tablet to your computer.

<img src="/img/tutorials/samsungConnectPC-1024x654.png" />
<br />

### 2.2 Navigate to the directory of your tablet

By default, tablets are configured in such a way that when they are connected to a computer, they function as a USB mass-storage device (just like a USB memory stick). This means that when you connect to a computer, the tablet will appear on the computer as another storage device with its own directory.

So, to be able to navigate to the directory of your tablet, open **Windows Explorer** and you should find your tablet (if you have named your tablet, you will see the name of the tablet) listed as a storage device.

<img src="/img/tutorials/navigate-to-the-directory-of-your-tablet.png" />
<br />

When you click on the name of your tablet, a sub-directory called ***'Tablet'*** will appear and then you will now see the contents of your tablet organised in folders.

<img src="/img/tutorials/22-navigate-to-the-directory-of-your-tablet.png" />
<br />

### 2.3 Find and open the Download folder of your tablet

Open the Download folder of your tablet by double-clicking on it.

<img src="/img/tutorials/find-and-open-the-download-folder-of-your-tablet.png" />
<br />

Your **Download** folder will contain all downloads that you have made on your tablet. In this case, there are no downloads yet on the tablet.

<img src="/img/tutorials/23-find-and-open-the-download-folder-of-your-tablet.png" />
<br />

### 2.4 Transfer the ODK Collect APK from your computer to the tablet's Download folder

Remember, you have placed the **ODK Collect APK** to the desktop which makes it more accessible to you for transferring into the tablets **Donwload** folder. Select the **ODK Collect APK** on your **Desktop** and then drag and drop it to copy into your tablet's **Download** folder.

<img src="/img/tutorials/transfer-the-odk-collect-apk-from-your-computer-to-the-tablet-s-download-folder.png" />
<br />

You will now see the **ODK Collect APK** on your tablet's **Download** folder.

<img src="/img/tutorials/24-transfer-the-odk-collect-apk-from-your-computer-to-the-tablet-s-download-folder.png" />
<br />
...
### 3.1 Go to Security settings of your tablet
...
### 3.1 &nbsp; Set-up tablet device to allow installation of applications outside of the Google Play Store
...
### 4.1 Navigate to the Download folder of your tablet
...
### 4.2 Tap on the ODK Collect APK
